...
export function useSession() {
  ...
  return {
    ...
    declareReadyToOrganize: fixture.declareReadyToOrganize,
    canDeclareReadyToOrganize: fixture.canDeclareReadyToOrganize,
    declareReadyToImport: fixture.declareReadyToImport,
    canDeclareReadyToImport: fixture.canDeclareReadyToImport,
